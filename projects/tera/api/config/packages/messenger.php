...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $transports = 'test' === $containerConfigurator->env() ? [
        ...
        'async' => [
            ...
            'options' => [
                ...
                'exchange' => [
                    ...
                    // tera may only publish under `tera.`. A message that carries a
                    // domain event sets its own key through an AmqpStamp; this is
                    // the fallback for plain background work, and it routes back
                    // to the tera.events queue.
                    'default_publish_routing_key' => 'tera.internal.message.v1',
                ],
                'queues' => [
                    'tera.events' => [],
                ],
                'delay' => [
                    ...
                    'queue_name_pattern' => 'tera.events.delay.%%routing_key%%.%%delay%%',
        ...
        // in tera.events.dlq — this one is what messenger:failed:* reads, exception
        // included.
