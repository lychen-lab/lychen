...
> **Note** : traduction française à destination des développeurs. Ce n'est **pas** la version de référence — en cas de divergence, [`architecture-espace.md`](./architecture-espace.md) (anglais) fait foi.
