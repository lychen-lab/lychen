...
CONFIG_FILE="/usr/share/caddy/html/config.js"
...
find /usr/share/caddy/html -name "*.html" | while read -r file; do
...
SITEMAP_FILE="/usr/share/caddy/html/sitemap.xml"
...
# Execute the CMD from Dockerfile (usually caddy)
exec "$@"